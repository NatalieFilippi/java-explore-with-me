...
public interface EventSrv {
    ...
    List<EventShortDto> findAll(String text, List<Long> categories, String paid, String rangeEnd, String rangeStart, String onlyAvailable, int size, int from, String sort) throws UnsupportedEncodingException;
